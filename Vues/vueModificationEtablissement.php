<?php $nomtitre = 'modifs etablissement'; ?>
<?php ob_start(); ?>
<?php
...
echo "
<form method='POST' action='vueModificationEtablissement.php?'>
   ...
   <table align='center' cellspacing='15' cellpadding='0'>
      ...
      <tr>
         <td colspan='2' align='center'><a href='vueEtablissement.php'>Retour</a>
         </td>
      </tr>
   </table>
